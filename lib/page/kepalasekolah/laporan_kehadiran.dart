...
class LaporanKehadiran extends StatefulWidget {
  @override
  _LaporanKehadiranPageState createState() => _LaporanKehadiranPageState();
}

class _LaporanKehadiranPageState extends State<LaporanKehadiran>
  ...
  Future<void> _fetchAttendanceReports() async {
    String url = "http:// 192.168.113.97/absensi/api/api_get_laporan.php";
  ...
  // Fungsi untuk mengambil data laporan kehadiran kelas dari API (absensi kelas)
  Future<void> _fetchAttendanceClassReports() async {
    String url =
        "http://192.168.113.97/absensi/api/api_get_laporan_absensi_kelas.php"; // API absensi kelas
        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(
              ...
              child: Text(
                report['nama']?[0] ?? report['mata_pelajaran'][0],
                style: TextStyle(color: Colors.white),
              ),
            ),
            title: Text(
              report['nama'] ?? report['mata_pelajaran'],
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            subtitle: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
