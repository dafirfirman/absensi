...
class _AdminProfilePageState extends State<AdminProfilePage> {
  ...
  void initState() {
    super.initState();
    getUserData(); // Ambil data pengguna saat inisialisasi
  }

  // Fungsi untuk mengambil nama, NIP/NGTA, dan gambar profil dari SharedPreferences
  Future<void> getUserData() async {
    ...
    setState(() {
      ...
      if (savedImagePath != null) {
        _imageFile = File(savedImagePath); // Memuat gambar jika ada
      }
    });
  }
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      ...
      _showImageEditDialog(); // Menampilkan dialog setelah gambar dipilih
    }
  }

  // Fungsi untuk menampilkan dialog edit gambar
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              child: Text('Simpan'),
              onPressed: () {
                _uploadImage(_imageFile!); // Simpan gambar
  ...
  Future<void> _uploadImage(File imageFile) async {
    var uri = Uri.parse(
        "http://172.20.10.3/absensi/api/api_upload_profile_image_admin.php");
